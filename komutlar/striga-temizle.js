...
exports.run = async(client, message, args, ayar, emoji) => {
  ...
  message.channel.bulkDelete(Number(args[0])).then(msjlar => message.channel.send(embed.setDescription(`<a:dnenyldz:814575735779360828> Başarıyla **${msjlar.size}** adet mesaj silindi! <a:dnenyldz:814575735779360828>`)).then(x => x.delete({timeout: 5000}))).catch()
};
exports.conf = {
    aliases: ["sil", 'clear'],
    usage: "temizle 1-100",
