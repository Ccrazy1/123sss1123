...
if(!["813855249470455858"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR")))
return message.reply("Bu İşlemi Sadece Move Liable Yetkilileri Yapabilir");
